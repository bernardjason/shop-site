...
class BasketTestCase(TestCase):
    def setUp(self):
        ...
        self.stockToAdd = Stock.objects.create(stockId='abc222222',description="add to basket",name="helloworld",numberOf=5)
    ...
    def test_addtobasket(self):
        ...
        item = {'name': self.stockToAdd.name, 'numberOf': 2, 'description': self.stockToAdd.description, 'stockId': self.stockToAdd.stockId}
        request_data = {
            "basketId":"hello-1",
            "userId":"hello",
            "items":[
    ...
    def test_delete_from_basket(self):
        ...
        item = {'name': self.stockToAdd.name, 'numberOf': 1, 'description': self.stockToAdd.description, 'stockId': self.stockToAdd.stockId}
        request_data = {
            "basketId":"hello-1",
            "userId":"hello",
            "items":[
